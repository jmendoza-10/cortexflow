...
function(expect_compile_fail)
    ...
    set(_cmd "out=$(\"${CMAKE_CXX_COMPILER}\" -std=c++17 -fno-rtti -fno-exceptions -I\"${PROJECT_SOURCE_DIR}/include\" -c \"${ECF_SOURCE}\" -o /dev/null 2>&1); rc=$?; if [ $rc -eq 0 ]; then echo 'compile-fail snippet unexpectedly succeeded' >&2; exit 1; fi; echo \"$out\" | grep -F -q \"${ECF_MATCHES}\" || { echo 'expected substring not found in diagnostic:' >&2; echo \"  needle: ${ECF_MATCHES}\" >&2; echo '  haystack:' >&2; echo \"$out\" >&2; exit 1; }")
